## Welcome to the null-cmd repository (Me) 👋
...
![Snake animation](https://github.com/nuLL-cmd/nuLL-cmd/blob/output/github-contribution-grid-snake.svg)
